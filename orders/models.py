...
class Order(models.Model):
    ...
    status = models.CharField(max_length=50, choices=STATUS_CHOICES, default="Принят", verbose_name="Статус заказа")
    table_number = models.CharField(max_length=20, verbose_name="Номер стола")
